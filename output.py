...
print range(0.5*TOT_GENES, 3*TOT_GENES, 0.5*TOT_GENES)
for sample_size in range(0.5*TOT_GENES, 3*TOT_GENES, 0.5*TOT_GENES):
    print sample_size
    ...
    construct_matrix.save_connection_matrix("data//data%d.dat" % sample_size, matrix)
